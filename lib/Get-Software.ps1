...
If this function is pathed in other scripts using dot-library [. <Drive-Letter>:\(Path)] the function can be called as a standalone subroutine without explicit calls.
#>
